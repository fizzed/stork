...
import com.fizzed.stork.launcher._
import com.fizzed.stork.bootstrap._
...
object StorkPlayPlugin extends AutoPlugin {
    ...
    override val projectSettings = Seq(
        ...
        libraryDependencies += "com.fizzed" % "fizzed-stork-bootstrap" % com.fizzed.stork.bootstrap.Version.getVersion(),
